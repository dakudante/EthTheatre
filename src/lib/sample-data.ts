...
export const screens: Screen[] = [
  // Aurora
  {
    ...
    projector_brand: "Barco", projector_model: "SP4K-55B",
    screen_brand: "Harkness", screen_dimensions: "88 x 47 ft",
    screen_width_ft: 88, screen_height_ft: 47,
  },
  {
    ...
    projector_brand: "Barco", projector_model: "DP4K-19B",
    screen_brand: "Harkness", screen_dimensions: "62 x 28 ft",
    screen_width_ft: 62, screen_height_ft: 28,
  },
  {
    ...
    projector_brand: "Barco", projector_model: "DP2K-20C",
    screen_brand: "Harkness", screen_dimensions: "54 x 23 ft",
    screen_width_ft: 54, screen_height_ft: 23,
  },
  // Galaxy
  {
    ...
    projector_brand: "IMAX", projector_model: "GT 4K Laser",
    screen_brand: "IMAX", screen_dimensions: "96 x 70 ft",
    screen_width_ft: 96, screen_height_ft: 70,
  },
  {
    ...
    projector_brand: "Barco", projector_model: "SP4K-55B",
    screen_brand: "Harkness", screen_dimensions: "70 x 30 ft",
    screen_width_ft: 70, screen_height_ft: 30,
  },
  {
    ...
    projector_brand: "NEC", projector_model: "NP-NC900C-A",
    screen_brand: "Harkness", screen_dimensions: "40 x 21 ft",
    screen_width_ft: 40, screen_height_ft: 21,
  },
  // Roxy
  {
    ...
    projector_brand: "Barco", projector_model: "DP4K-19B",
    screen_brand: "Harkness", screen_dimensions: "64 x 27 ft",
    screen_width_ft: 64, screen_height_ft: 27,
  },
  {
    ...
    projector_brand: "Barco", projector_model: "SP4K-55B",
    screen_brand: "STRONG MDI", screen_dimensions: "72 x 31 ft",
    screen_width_ft: 72, screen_height_ft: 31,
  },
  {
    ...
    projector_brand: "Barco", projector_model: "DP4K-23B",
    screen_brand: "Harkness", screen_dimensions: "45 x 20 ft",
    screen_width_ft: 45, screen_height_ft: 20,
  },
  // Northgate
  {
    ...
    projector_brand: "Christie", projector_model: "4K RGB Laser",
    screen_brand: "Harkness", screen_dimensions: "58 x 24 ft",
    screen_width_ft: 58, screen_height_ft: 24,
  },
  {
    ...
    projector_brand: "NEC", projector_model: "NP-NC900C-A",
    screen_brand: "Harkness", screen_dimensions: "38 x 20 ft",
    screen_width_ft: 38, screen_height_ft: 20,
  },
];
...
export const movies: Movie[] = [
  {
    ...
    created_at: "2024-01-01T00:00:00Z",
    dcp_variants: {
      normal_venue: ["2K 5.1", "2K 7.1"],
      atmos_venue: ["4K 7.1 ATMO"],
      imax: ["4K 5CH IMAX DMR", "4K 12CH IMAX DMR"],
      epiq: null,
    },
    aspect_ratio_primary: "IMAX 1.90:1",
    aspect_ratio_secondary: "Scope 2.39:1",
    is_variable_aspect: true,
    aspect_ratio_variants: ["IMAX 1.90:1", "Scope 2.39:1"],
    venue_types: ["Laser", "IMAX"],
    has_3d: false, has_hfr: false, frame_rate: 24, is_upscaled: false,
  },
  {
    ...
    dcp_variants: {
      normal_venue: ["2K 5.1"],
      atmos_venue: ["4K 7.1 ATMO"],
      imax: ["4K 12CH IMAX DMR"],
      epiq: null,
    },
    aspect_ratio_primary: "IMAX 1.43:1",
    aspect_ratio_secondary: "70mm 2.20:1",
    is_variable_aspect: true,
    aspect_ratio_variants: ["IMAX 1.43:1", "70mm 2.20:1"],
    venue_types: ["IMAX 70mm", "Laser"],
    has_3d: false, has_hfr: false, frame_rate: 24, is_upscaled: false,
  },
  {
    ...
    aspect_ratio_secondary: "Scope 2.39:1",
    is_variable_aspect: true,
    aspect_ratio_variants: ["IMAX 1.43:1", "Scope 2.39:1"],
    venue_types: ["IMAX 70mm", "Laser"],
    has_3d: false, has_hfr: false, frame_rate: 24, is_upscaled: false,
  },
  {
    ...
    aspect_ratio_primary: "Scope 2.39:1",
    aspect_ratio_secondary: null,
    is_variable_aspect: false,
    aspect_ratio_variants: ["Scope 2.39:1"],
    venue_types: ["Laser", "Dolby Vision"],
    has_3d: false, has_hfr: false, frame_rate: 24, is_upscaled: false,
  },
  {
    ...
    created_at: "2024-01-01T00:00:00Z",
    dcp_variants: {
      normal_venue: ["2K 5.1", "2K 7.1 3D"],
      atmos_venue: ["4K 7.1 ATMO"],
      imax: ["4K 12CH IMAX DMR 3D"],
      epiq: ["4K 7.1 ATMO 3D"],
    },
    aspect_ratio_primary: "Scope 2.39:1",
    aspect_ratio_secondary: null,
    is_variable_aspect: false,
    aspect_ratio_variants: ["Scope 2.39:1"],
    venue_types: ["Laser", "IMAX", "4DX"],
    has_3d: true, has_hfr: false, frame_rate: 24, is_upscaled: false,
  },
  {
